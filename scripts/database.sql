...
create table if not exists communities (
    ...
    description varchar(256) not null default 'Community Description',
...
create table if not exists posts (
    ...
    index fk_community1_idx (community_id asc),
...
create table if not exists comments (
    ...
    index fk_comments3_idx (parent_id asc),
...
create table if not exists comment_likes (
    ...
    index fk_comments1_idx (comment_id asc),
...
create table if not exists post_dislikes (
    ...
    index fk_posts1_idx (post_id asc),
...
create table if not exists comment_dislikes (
    ...
    comment_id int not null,
    primary key (dislike_id),
    index fk_comments2_idx (comment_id asc),
...
create table if not exists saved_posts (
    ...
    index fk_posts2_idx (post_id asc),
...
create table if not exists saved_comments (
    ...
    index fk_comments4_idx (comment_id asc),
...
create table if not exists followers (
    ...
    primary key (link_id),
    index fk_users6_idx (user_id asc),
    index fk_users7_idx (follower_id asc),
...
create table if not exists joined_communities (
    ...
    community_id int not null,
    primary key (link_id),
    index fk_users8_idx (user_id asc),
    index fk_communities1_idx (community_id asc),
...
create table if not exists access_codes (
    ...
    primary key (code),
    index fk_users9_idx (user_id asc),
